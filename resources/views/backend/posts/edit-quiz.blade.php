    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12">
                    <form action="{{ route('backend.posts.updateQuiz', $item->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-md-8">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    @include('backend.fields.edit.options')
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="card card-default">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                @include('backend.fields.common.action', ['url' => route('backend.posts.quiz', $item->post_id)])
                                            </div>
                                        </div>
                                    </div>
                                </div>

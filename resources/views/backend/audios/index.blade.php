...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Audios</h1>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="{{ route('backend.audios.create') }}" class="btn btn-success">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <div class="form-inline">
                                    <div class="form-group">Audios</div>
                                </div>
                            </div>
                        ...
                        <div class="card-body table-responsive p-0">
                            <form method="POST" action="{{ route('backend.audios.delete') }}" id="form-delete-items">
                                @method('DELETE')
                                @csrf
                                    ...
                                    @forelse ($list as $item)
                                        <tr class="ui-state-default">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('backend.audios.edit', $item->id) }}" class="btn btn-sm btn-warning">
